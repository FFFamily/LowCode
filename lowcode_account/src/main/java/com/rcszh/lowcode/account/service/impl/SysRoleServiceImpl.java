...
import com.rcszh.lowcode.account.entity.SysRoleDept;
import com.rcszh.lowcode.account.entity.SysRoleMenu;
import com.rcszh.lowcode.account.entity.SysUserRole;
import com.rcszh.lowcode.account.entity.core.SysRole;
import com.rcszh.lowcode.account.mapper.SysRoleDeptMapper;
import com.rcszh.lowcode.account.mapper.SysRoleMapper;
import com.rcszh.lowcode.account.mapper.SysRoleMenuMapper;
import com.rcszh.lowcode.account.mapper.SysUserRoleMapper;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public void checkRoleAllowed(SysRole role) {
        if (StringUtils.isNotNull(role.getId()) && RoleUtil.idAdmin(role.getId()) ) {
